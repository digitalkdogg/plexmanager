...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <ul class="pure-menu-list">
        @foreach ($menunav as $menu) 
            <li class = "{{$menu['classlist']}}">
                <a href = "{{$menu['href']}}" class = "{{$menu['aclasslist']}}">{{$menu['name']}}</a>
            </li>
        @endforeach
      ...
      <!--  <li class="pure-menu-item pure-menu-selected"><a href="/home" class="pure-menu-link">Home</a></li>
        <li class="pure-menu-item pure-menu-has-children pure-menu-allow-hover">
            ...
            <ul class="pure-menu-children">
                <li class="pure-menu-item"><a href="/scan" class="pure-menu-link">Scan</a></li>
        ...
        <li class = "pure-menu-item pure-menu-selected">  <a href="/settings" id="menuLink1" class="pure-menu-link">Settings</a></li>
    -->
    </ul>
</div>
